...
export function clearPersistedRemediationState(
  context: vscode.ExtensionContext
): void {
  void context.workspaceState.update(LIVE_REMEDIATION_STORAGE_KEY, undefined);
  void context.workspaceState.update(LEGACY_LIVE_REMEDIATION_STORAGE_KEY, undefined);
}
